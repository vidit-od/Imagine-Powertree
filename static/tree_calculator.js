...
let mode_dict = {
    ...
    2: '<div class="capacity_input"> <p>1. Enter solar capacity you want to install:</p> <div class="field"> <input type="number" name="" id="capacity" min="0"> <div class="symbol"> KW </div> </div> </div>  ',
}
